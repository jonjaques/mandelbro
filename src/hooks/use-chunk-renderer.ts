...
import { getContext2D, imageDataSettings } from "@/lib/mandelbrot/wide-gamut";
 ...
 *
 * Painting goes through a 2D canvas context (`putImageData`) with an optional
 * `display-p3` color space when wide-gamut mode is on.
 */
